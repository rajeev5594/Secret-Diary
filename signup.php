...
<div class="login-form">
    <form action="formsignup.php" method="post">
        ...
        <p class="text-center">Log in By using your username and password.</p>       
    ...
    <p class="text-center" style="padding: 10px; font-size: 20px;"><a href="index.php"><b>Sign Up!</b></a></p>
</div>
</body>
</html>